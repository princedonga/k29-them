...
function Header() {
    ...
    return (
        <div className='position-sticky top-0 z-3 bg-white box-shadow'>
            <section className=''>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-12 '>
                                <div class="input-group mb-3  w-25 m-input float-end me-5">
                                    <input type="text" className="form-control" placeholder="Search Heare" />
